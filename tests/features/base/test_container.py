...
class TestFeatureContainer:
    ...
    def test_validate_parameters_missing_required(self):
        arg1 = ArgumentMetadata(name="required_param", type_hint=int, required=True, default=None)
        func_metadata = FunctionMetadata(
            name="test_func",
            arguments=[arg1],
            description="Test function",
    ...
    def test_validate_parameters_type_casting_error(self):
        ...
        with patch.object(JsonSchemaTypes, 'cast_python_type', side_effect=ValueError("Invalid")):
